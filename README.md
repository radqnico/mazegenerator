...
## Notes
- The plugin never preloads chunks. Each job loads only the chunk(s) it needs at the time of placement.
- On Folia, region tasks are used where possible; work still loads chunks on demand per job.
